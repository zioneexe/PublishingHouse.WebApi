...
namespace PublishingHouse.WebApi.Controller
{
    ...
    public class OrderBookController(IOrderBookService service, IMapper<IOrderBook, OrderBookRequestDto, OrderBookResponseDto> mapper) : ControllerBase
    {
        [HttpGet]
        ...
        [HttpPost]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Create([FromBody] OrderBookRequestDto dto)
        {
            try
            {
        ...
        [Authorize(Roles = "Admin, Employee")]
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] OrderBookRequestDto dto)
        {
            try
            {
        ...
        public async Task<IActionResult> GetByOrderId([FromRoute] int orderId)
        {
            try
            {
                var orderBooks = await service.GetBooksByOrderIdAsync(orderId);
