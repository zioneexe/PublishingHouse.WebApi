...
{
    [ApiController]
    [Route("api/production-types")]
    [Authorize(Roles = "Admin")]
    public class ProductionTypeController(IProductionTypeService service, IMapper<IProductionType, ProductionTypeRequestDto, ProductionTypeResponseDto> mapper) : ControllerBase
    {
        [HttpGet]
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ProductionTypeRequestDto dto)
        {
            try
            {
        ...
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] ProductionTypeRequestDto dto)
        {
            try
            {
